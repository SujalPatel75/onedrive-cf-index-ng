...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'iam@sujalpatel.onmicrosoft.com',
  ...
  footer:
    'Powered by <a href="https://patelsujal.in" target="_blank" rel="noopener noreferrer">onedrive-cf-index-ng</a>. Made with ❤ by Sujal',
  ...
  email: 'mailto:mail@patelsujal.in',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/SujalPatel75',
    },
  ],
